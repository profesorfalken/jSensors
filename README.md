...
First of all, download the JAR file containing all dependencies: https://github.com/profesorfalken/profesorfalken.github.io/blob/master/files/jSensors-2.1.1-jar-with-dependencies.jar
